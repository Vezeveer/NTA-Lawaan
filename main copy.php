	...
	<div class="d-flex" id="wrapper">
            ...
            <div class="border-end bg-white" id="sidebar-wrapper">
                <div class="sidebar-heading border-bottom bg-light">
                    <div>
                        <img class="sidebar-logo" src="..\img\nta_logo_small.png"/>
                        <p id="user-logged-in">Barangay Development Council</p>
                    </div>
                    <div id="sidebarToggleContainer">
                        <span class="tooltiptext">hide/show</span>
                        <button class="btn" id="sidebarToggle">
                            <img src="img/CaretLeft.svg"/>
                        </button>
                    </div>
                </div>
                <div class="sidenav">
            ...
            <div id="page-content-wrapper">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
                    <div class="container-fluid">
                        <h2 id="who-is-logged">Barangay Development Council</h2>
