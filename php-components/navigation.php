    ...
    <div class="collapse navbar-collapse text-dark" id="navbarNavDropdown">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item d-sm-block d-md-none">
                <a class="nav-link <?php echo ($activePage == 'dashboard') ? 'active_page ':''; ?>" href="dashboard.php"><i class="fas fa-home"></i> Dashboard<span class="sr-only">(current)</span></a>
            </li>
            <?php
            ...
            ?>
            <li class="nav-item d-sm-block d-md-none">
                <a class="nav-link <?php echo ($activePage == 'main') ? 'active_page ':''; echo $EnableMobiCurrPlanBtn ? '' : 'disabled'?>" href="main.php"><i class="fas fa-tasks"></i> Current Plan</a>
            </li>
            <?php
            if($_SESSION['adminAccess']){
                echo "<li class=\"nav-item d-sm-block d-md-none\">
